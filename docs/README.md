# CORES Runtime — Documentation

This directory contains the developer documentation for the CORES Runtime.
...
All significant architectural decisions are documented as ADRs in [`.ai/ADR/`](../.ai/ADR/README.md).
